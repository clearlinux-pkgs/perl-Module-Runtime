...
Requires: perl-Module-Runtime-license = %{version}-%{release}
...
%package license
Summary: license components for the perl-Module-Runtime package.
Group: Default

%description license
license components for the perl-Module-Runtime package.
...
%prep
%setup -q -n Module-Runtime-0.018
cd %{_builddir}/Module-Runtime-0.018
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/perl-Module-Runtime
cp %{_builddir}/Module-Runtime-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Module-Runtime/37658f33f4351e9c5b3613a863ccb066a9468ba4 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Module-Runtime/37658f33f4351e9c5b3613a863ccb066a9468ba4
